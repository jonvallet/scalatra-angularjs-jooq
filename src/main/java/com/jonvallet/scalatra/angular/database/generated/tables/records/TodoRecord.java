...
public class TodoRecord extends UpdatableRecordImpl<TodoRecord> implements Record4<Integer, String, String, Boolean> {

	private static final long serialVersionUID = 1014047139;
	 ...
	 */
	@Override
	public TodoRecord values(Integer value1, String value2, String value3, Boolean value4) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public TodoRecord(Integer id, String name, String description, Boolean done) {
		super(Todo.TODO);
